...
{
    public abstract class QaflabGhanatWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QaflabGhanatWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QaflabGhanatWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QaflabGhanatDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QaflabGhanatDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QaflabGhanatDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QaflabGhanatDbContext, Task<T>> func)
        {
            T result;
